...
def analyze_report(report_text: str) -> str:
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            {"role": "system", 
             "content": "Analyze the blood test report and format the results into a JSON structure. Each element should be a separate key-value pair, grouped logically. Add a summary at the end as a key-value pair titled 'Summary' explaining clearly the report (including possible common reasons and recommended checks or procedure) in key-value pair, where the keys are the areas of focus.  in the Summary above, explain clearly using general patterns that clinicians may use to interpret. if the marker is above the reference range, explain whether it is considered mild or moderate or high elevation and its common association. do not return anything after the json."},
